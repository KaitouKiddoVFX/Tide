	...
	: Layer("Example"), m_CameraController(1280.0f / 720.0f)
{
	...
	m_ChernoLogoTexture = Tide::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(Tide::Timestep ts)
{
	// Update
	m_CameraController.OnUpdate(ts);

	// Render
	Tide::RenderCommand::SetClearColor({ 0.1f, 0.1f, 0.1f, 1 });
...
void ExampleLayer::OnEvent(Tide::Event& e)
{
